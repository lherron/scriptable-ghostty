...
extension UpdateDriver: SPUUpdaterDelegate {
    func feedURLString(for updater: SPUUpdater) -> String? {
        // ScriptableGhostty releases are published independently. Never offer
        // an upstream Ghostty build as an update for the fork.
        if Bundle.main.bundleIdentifier == "com.lherron.scriptableghostty" {
            return nil
        }
